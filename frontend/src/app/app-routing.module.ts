...
const routes: Routes = [
  ...
  //activity views
  {path: 'activity-view', component: ActivityViewComponent, canActivate: [AuthGuard]},
  {path: 'activity-view/:filter', component: ActivityViewComponent, canActivate: [AuthGuard]},
